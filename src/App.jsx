...
function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <header className="bg-slate-950 text-white shadow-lg border-b-2 border-red-600">
        <div className="max-w-5xl mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-start gap-4">
              <div className="flex flex-col items-center gap-1">
                ...
                <div className="flex flex-col gap-0.5">
                  <div className="w-2 h-2 rounded-full bg-red-500 animate-pulse mx-auto" />
                  <div className="w-2 h-2 rounded-full bg-red-800 mx-auto" />
                  <div className="w-2 h-2 rounded-full bg-red-800 mx-auto" />
                </div>
              </div>
              ...
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-xs font-mono bg-red-600 text-white px-2 py-0.5 rounded uppercase tracking-widest">
                    Informe de incidente
                  </span>
                  <span className="text-xs font-mono text-slate-500">REF-2017-EQX</span>
                </div>
                <h1 className="text-2xl md:text-3xl font-black text-white leading-tight tracking-tight">
                  CASO EQUIFAX
                  <span className="text-red-500"> 2017</span>
                </h1>
            ...
            <button
              ...
              className="flex items-center gap-2 bg-slate-800 hover:bg-slate-700 border border-slate-700 transition-colors px-3 py-1.5 rounded text-xs font-medium self-start md:self-center"
            >
              {darkMode
      ...
      <a
        ...
        className="fixed bottom-6 right-6 flex items-center gap-2 bg-slate-900 hover:bg-slate-700 hover:scale-105 hover:-translate-y-1 text-white px-4 py-3 rounded-full shadow-lg transition-all duration-300 ease-in-out text-sm font-medium z-50"
      >
        <svg
